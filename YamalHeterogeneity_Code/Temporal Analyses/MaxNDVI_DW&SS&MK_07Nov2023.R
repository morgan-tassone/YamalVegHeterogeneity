...
#Reload Max NDVI MK data
MaxNDVI_MKsl <- readRDS(file = "MaxNDVI_Updated/UpdatedMaxNDVI_MKresults_22March2021.RDS")
...
MaxNDVI_sig_only <- MaxNDVI_MKresult %>%
...
#Export as an R object
saveRDS(MaxNDVI_sig_only, file="UpdatedMaxNDVI_SigOnly_07Nov2023.RDS")
