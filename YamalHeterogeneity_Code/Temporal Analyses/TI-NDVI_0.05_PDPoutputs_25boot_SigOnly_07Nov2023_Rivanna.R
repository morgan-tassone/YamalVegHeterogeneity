...
RFR_input <- read_excel("./RFRinput_TINDVI0.05_SigOnly_07Nov2023.xlsx",
                        na = "NA")
...
RFRslope_model_SigOnly <- train(TINDVI~., data=RFR_input, method='rf', tuneGrid=tunegrid, trControl=control, importance=TRUE)
...
saveRDS(CoastDistPDP, file="TI-NDVI_CoastDist_PDPdata_07Nov2023.RDS")
...
saveRDS(ElevationPDP, file="TI-NDVI_Elevation_PDPdata_07Nov2023.RDS")
...
saveRDS(HumanModPDP, file="TI-NDVI_HumanMod_PDPdata_07Nov2023.RDS")
...
saveRDS(LandAgePDP, file="TI-NDVI_LandAge_PDPdata_07Nov2023.RDS")
...
saveRDS(PrecipPDP, file="TI-NDVI_Precip_PDPdata_07Nov2023.RDS")
...
saveRDS(SnowFreePDP, file="TI-NDVI_SnowFree_PDPdata_07Nov2023.RDS")
...
saveRDS(SoilMoisturePDP, file="TI-NDVI_SoilMoisture_PDPdata_07Nov2023.RDS")
...
saveRDS(SoilTexturePDP, file="TI-NDVI_SoilTexture_PDPdata_07Nov2023.RDS")
...
saveRDS(SubChemPDP, file="TI-NDVI_SubChem_PDPdata_07Nov2023.RDS")
...
saveRDS(SummerWarmthPDP, file="TI-NDVI_SummerWarmth_PDPdata_07Nov2023.RDS")
...
saveRDS(VegUnitPDP, file="TI-NDVI_VegUnit_PDPdata_07Nov2023.RDS")

jpeg(file="TI-NDVI_IncMSEmodel_SigOnly_07Nov2023.jpeg")
varImpPlot(finalModel_SigOnly, type = 1, main = "TI-NDVI 0.05 (Significant Trends) Random Forest Regression Results")
dev.off()

save(finalModel_SigOnly, file="TI-NDVI_UpdatedRFRmodel_25boot_SigOnly_07Nov2023.Rdata")